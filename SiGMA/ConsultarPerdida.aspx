<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="ConsultarPerdida.aspx.cs" Inherits="SiGMA.ConsultarPerdida" %>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btnCancelar" runat="server" Text="Cancelar" 
                                            onclick="btnCancelar_Click" /> -  <asp:Button ID="btnModificar" 
                                        runat="server" Text="Modificar" onclick="btnModificar_Click" />
                                </td>
                            </tr>
                        </table>
                        </div>
