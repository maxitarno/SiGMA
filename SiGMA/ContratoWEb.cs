...
namespace SiGMA {
    ...
    public class ContratoWEb : ReportClass {
    ...
    public class CachedContratoWEb : Component, ICachedReport {
        
        public CachedContratoWEb() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ContratoWEb rpt = new ContratoWEb();
            rpt.Site = this.Site;
            return rpt;
        }
