...
namespace SiGMA {
    ...
    public class Metricas : ReportClass {
    ...
    public class CachedMetricas : Component, ICachedReport {
        
        public CachedMetricas() {
        }
